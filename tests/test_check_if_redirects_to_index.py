...
class TestCheckIfRedirectsToIndex(unittest.TestCase):
    ...
    def test_redirects_to_index(self, mock_head):
        ...
        mock_response.headers = {
            'Location': 'https://unicef.github.io/magasin/mag-cli/mag_superset/index.html'}
    ...
    def test_does_not_redirect(self, mock_head):
        ...
        url = "https://site.com/magasin/mag-cli/mag_superset"
    ...
    def test_redirects_to_non_index(self, mock_head):
        ...
        mock_response.status_code = 302
        mock_response.headers = {
            'Location': 'https://site.com/magasin/mag-cli/mag_superset/other.html'}
        mock_head.return_value = mock_response
    ...
    @patch('requests.head')
    def test_redirects_to_slash(self, mock_head):
        mock_response = Mock()
        mock_response.status_code = 302
        mock_response.headers = {
            'Location': 'https://site.com/magasin/mag-cli/mag_superset/'}
        mock_head.return_value = mock_response
